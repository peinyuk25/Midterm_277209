...
class CustomersDetailsScreen extends StatefulWidget {
  ...
  @override
  State<CustomersDetailsScreen> createState() => _CustomersDetailsScreenState();
}

class _CustomersDetailsScreenState extends State<CustomersDetailsScreen> {
  TextEditingController _prnameEditingController = TextEditingController();
  TextEditingController _prdescEditingController = TextEditingController();
  TextEditingController _prpriceEditingController = TextEditingController();
  TextEditingController _prqtyEditingController = TextEditingController();
  TextEditingController _prstateEditingController = TextEditingController();
  TextEditingController _prlocalEditingController = TextEditingController();
